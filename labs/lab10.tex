...
\begin{ex}[library.py]
    ...
    \item[class Library] A \lstinline{Library} object stores multiple
        ...
        \begin{description}
        \item[def add_book(self, book)] This method takes in either a line of
        ...
        \item[def get_authors(self)] This method returns a list of all the
            authors who have works contained in the library. No author should
            appear more than once.
        \item[def get_books_per_author(self)] This method returns a dictionary.
