...
The special function \pythoninline{__str__(self)} can be defined to override
...
\pythoninline{__str__} function, while \pythoninline{Book} does not. This means
that \pythoninline{Book} simply uses the function that it inherits from
...
\begin{ex}[tree.py]
    ...
    \item[class Tree] The class used to create objects representing trees. Each
        ...
        \item[def height(self)] Returns the height of the tree that this node
            ...
            its height is 0.
        \item[def add_item(self, item)] Create a new \pythoninline{Tree} object
