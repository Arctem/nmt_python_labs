...
\begin{description}
  \item[mathutils.py] Write a Python file that contains the following functions:
  ...
  \item[calls.py] You buy an international calling card to Germany. The calling
...
Files to submit:
\begin{itemize}
  \item mathutil.py (Section~\ref{subsec:funcs.ex})
  \item calls.py (Section~\ref{subsec:funcs.ex})
  \item sum.py (Section~\ref{subsec:adv.ex})
  \item expo.py (Section~\ref{subsec:adv.ex})
\end{itemize}
