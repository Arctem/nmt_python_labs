...
\label{subsec:arg}
Many of the built-in functions we have been using, such as \pythoninline{range} or
\pythoninline{input}, accept a variable number of arguments. We can do the same
...
\pythoninline{"Yay!"} once, since the default argument is \pythoninline{1}, while the
