...
\begin{ex}[car.py, tire.py, engine.py, race.py]
  ...
  second of a 10 second trip. The car's tires have a radius of 1 and a
  traction of 1. The car's engine has a max speed of 100 and an acceleration of
  0.5.
  ...
  \begin{table}[!ht]
    ...
    \toprule
    Time $(s)$ & Distance $(m)$ & Car Speed $(m)$ & Engine Speed $(\frac{rot}{s})$\\
    \midrule
    0 & 0 & 0  & 0\\
    \bottomrule
    \end{tabular}
    \label{carexample}
    \caption{Example of a Car's Performance}
  \end{table}
\end{ex}
