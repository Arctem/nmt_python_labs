...
How many sides? 3
  ...
  \item[navigate.py] Write a program that takes directions from the command line
    ...
    are entered, forward moves the turtle forward, and stop ends the program.
    Please check the degrees for errors: they must be between 0 and 360 degrees!
    (Yes, Turtle could handle negative degrees, but we would like you to check.)
    Also, just pick a number of pixels that forward should move forward.
