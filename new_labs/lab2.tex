...
It should be noted that giving a negative value to these commands is allowed, so \lstinline!turtle.left(-30)! is equivalent to \lstinline!turtle.right(30)!.
...
\item[navigate.py] Write a program that takes directions from the command line to draw a line. Let the user input ``left'', ``right'', ``forward'', or ``stop''. Left and right turn the turtle left or right 45 degrees, forward moves the turtle forward, and stop ends the program.

  Input:
  \begin{lstlisting}[style=ipython]
Please input a direction: forward
Please input a direction: left
Please input a direction: forward
Please input a direction: left
Please input a direction: forward
Please input a direction: forward
...
Please input a direction: left
Please input a direction: forward
Please input a direction: right
Please input a direction: forward
Please input a direction: stop
  \end{lstlisting}
